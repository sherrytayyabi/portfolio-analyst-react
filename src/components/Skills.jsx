...
import Office from '../assets/SkillsPhotos/moffice.png';
import RStudio from '../assets/SkillsPhotos/rs.png';
        ...
        <div name='skills' className=' w-full bg-[#0a192f] text-gray-300 pt-8'>
            ...
            <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
                ...
                <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
                 ...
                 <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
                    <img className='w-20 mx-auto' src={RStudio} alt="RStudio" />
                    <p className='my-9'>R Studio</p>
                 </div>
